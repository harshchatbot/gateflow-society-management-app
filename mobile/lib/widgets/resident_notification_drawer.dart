...
class ResidentNotificationDrawer extends StatefulWidget {
  ...
  @override
  State<ResidentNotificationDrawer> createState() =>
      _ResidentNotificationDrawerState();
}

class _ResidentNotificationDrawerState
    extends State<ResidentNotificationDrawer> {
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      if (approvalsResult.isSuccess && approvalsResult.data != null) {
        ...
        approvalNotifications = allApprovals.take(5).map((a) {
          ...
          final hasDeliveryPartner = isDelivery &&
              ((dp != null && dp.isNotEmpty) ||
                  (dpo != null && dpo.isNotEmpty));
          final deliveryLabel = hasDeliveryPartner
              ? (dp == 'Other'
                  ? (dpo?.isNotEmpty == true ? dpo! : 'Other')
                  : (dp ?? ''))
              : null;
      ...
      AppLogger.e("Error loading resident notifications",
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      if (type == 'visitor' &&
                          notification['visitor_type'] != null) ...[
                        const SizedBox(width: 12),
