...
class VisitorService:
    ...
    def create_visitor(
        ...
        # TODO: Trigger WhatsApp/SMS approval message (stub for now)
        self._send_approval_request(flat, visitor_data)
    ...
    def _send_approval_request(self, flat: dict, visitor_data: dict):
        """
        Send WhatsApp/SMS approval request to resident
        ...
        print(f"[STUB] Would send approval request to {resident_phone}")
        print(f"      Flat: {flat_no}, Visitor: {visitor_type} ({visitor_phone})")
        print(f"      Reply YES/NO to approve/reject")
